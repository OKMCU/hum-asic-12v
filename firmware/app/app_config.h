...
#define WATER_INDEX_NO_WATER_HI_THRESHOLD    270//270 // Aug 2019: Tuned to ~500mA normal working current, setting changed from 350 to 300
#define WATER_INDEX_NO_WATER_LO_THRESHOLD    50 //110 // Aug 2019: Tuned to ~500mA normal working current, setting changed from 50 to 110
#endif
